defmodule Offgrid.Utils.SVGTest do
  ...
  describe "smooth_path/1" do
    ...
    test "bends a three-point stroke around its middle" do
      assert smooth_path([{0, 0}, {10, 0}, {20, 10}]) == "M0,0 Q10,0 15.0,5.0 L20,10"
    end
    ...
    test "names a control once and continues from it" do
      d = smooth_path([{0, 0}, {10, 0}, {20, 10}, {30, 10}, {40, 0}])
    ...
    test "starts and ends on the points the hand gave it" do
      d = smooth_path([{1, 2}, {5, 9}, {11, 3}, {17, 8}])
